      ...
      <header className="h-[76px] bg-white/95 backdrop-blur-xl flex items-center px-4 md:px-7">
        <div className="flex items-center gap-4 w-full">
          ...
          <div className="flex-1 max-w-[460px] group">
            <div className="flex items-center gap-2.5 bg-[#f8f6ff]/80 border border-[#7c3aed1a] rounded-xl px-3.5 py-2 shadow-sm transition-all duration-200 group-focus-within:bg-white group-focus-within:border-[#7c3aed4d] group-focus-within:ring-4 group-focus-within:ring-[#7c3aed0d] group-focus-within:shadow-md">
              <Search className="text-[#8b5cf6] shrink-0" size={15} />
              <input
                type="text"
                placeholder="Buscar artistas, empresas..."
                className="bg-transparent outline-none w-full text-[13px] font-medium text-[#1e1b4b] placeholder:text-[#8b5cf6]/70 placeholder:font-normal"
              />
          ...
          <div className="flex items-center gap-2.5 ml-auto shrink-0">
            {/* Notification Button */}
            <button className="relative w-10 h-10 md:w-[42px] md:h-[42px] flex items-center justify-center bg-[#f8f6ff]/80 border border-[#7c3aed1a] rounded-xl shadow-sm hover:bg-white hover:border-[#7c3aed40] hover:-translate-y-0.5 transition-all cursor-pointer group">
            ...
            {/* Create Button */}
            <button className="relative overflow-hidden bg-gradient-to-br from-[#7c3aed] to-[#2563eb] px-4 md:px-5 py-2.5 rounded-xl text-white font-bold text-[13px] md:text-[13.5px] shadow-[0_6px_18px_rgba(124,58,237,0.22)] hover:shadow-[0_10px_28px_rgba(124,58,237,0.32)] hover:-translate-y-0.5 active:translate-y-0 active:shadow-sm transition-all flex items-center gap-2 group cursor-pointer">
